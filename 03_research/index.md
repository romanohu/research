# 研究
- [論文読むときに使っているツール](research_read_method.html)
- [論文探すときに使っているツール](research_explore_method.html)
- [Author list(著者メモ)](Authors/)
...
## ML
データから学習したパターンをもとに、未知のデータに対して予測や判断を行う技術・研究分野．
- [学習メモ](ML/index)
