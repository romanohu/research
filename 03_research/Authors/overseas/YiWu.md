...
Yi Wu は OpenAI の研究者で、MARL 論文群の著者として確認できる。([source](https://openreview.net/profile?id=~Yi_Wu1), [source](https://arxiv.org/abs/1910.05512))

## 調査
- 主要研究領域: reinforcement learning, multi-agent learning（公開論文実績） ([source](https://openreview.net/profile?id=~Yi_Wu1))
- 個人ホームページ: 未確認（要調査）
- 所属: OpenAI（OpenReview 記載） ([source](https://openreview.net/profile?id=~Yi_Wu1))
