...
Yanping Huang は mixture-of-experts routing, sparse expert models に関連する研究論文の著者として確認できる研究者。([source](https://arxiv.org/abs/2202.09368))

## 調査
- 主要研究領域: mixture-of-experts routing, sparse expert models ([source](https://arxiv.org/abs/2202.09368))
- 個人ホームページ: 未確認（要調査）
- 所属: 未確認（要調査）
